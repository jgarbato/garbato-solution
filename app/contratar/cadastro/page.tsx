        ...
        <div className="max-w-2xl mx-auto relative z-10">
          ...
          >
            <div>
              ...
              <div className="text-[15px] font-semibold text-[#EEF1F8]">
                Plano {planLabel} —{" "}
                <span style={{ color: sistemaColor }}>
                  R$ {price.toLocaleString("pt-BR")}/mês
                </span>
              </div>
              <div className="text-[11px] text-[#71789A] mt-0.5">
            ...
            <div className="flex gap-2 mb-6">
              {(["pj", "pf"] as const).map((t) => (
                <button
                  ...
                  style={{
                    background: tipoPessoa === t ? "rgba(91,155,255,0.14)" : "#18223A",
                    color: tipoPessoa === t ? "#5B9BFF" : "#AFB6CC",
                    border: tipoPessoa === t ? "1px solid rgba(91,155,255,0.35)" : "1px solid var(--gs-border)",
                  }}
                >
...
function Field({
  ...
  return (
    <div>
      <label className="block text-[12px] font-semibold text-[#AFB6CC] mb-1.5 uppercase tracking-wider">
        {label}
      </label>
      <div className="relative">
        {icon && (
          <div className="absolute left-3 top-1/2 -translate-y-1/2 text-[#71789A]">{icon}</div>
        )}
        <input
          type={type}
          value={value}
          ...
          maxLength={maxLength}
          className="w-full rounded-xl py-3 text-[14px] text-[#EEF1F8] placeholder-[#71789A] outline-none transition-all"
          style={{
            background: "#0A0E1A",
