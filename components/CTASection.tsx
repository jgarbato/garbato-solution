  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        {/* Center glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[400px] rounded-full blur-[100px] bg-[#3B82F6]/[0.12]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[250px] rounded-full blur-[60px] bg-[#7C3AED]/[0.10]" />
        {/* Top line */}
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center" ref={ref}>
        ...
        >
          <motion.div
            animate={{ boxShadow: ["0 8px 24px rgba(59,130,246,0.25)", "0 12px 40px rgba(59,130,246,0.45)", "0 8px 24px rgba(59,130,246,0.25)"] }}
        ...
        >
          ...
          <motion.a
            ...
            className="flex items-center gap-2.5 px-8 py-4 bg-[#25D366] hover:bg-[#20BA5A] text-white font-semibold text-lg rounded-xl transition-colors shadow-[0_8px_28px_rgba(37,211,102,0.35)]"
          >
